      ...
      <main>
        <article>
          <p>
            ...
            <a href="https://nushackers.org" target="_blank">NUS Hackers </a>for{' '}
            <em>Advent of Code 2024</em>. It is generated by aggregating the 2
            private leaderboards used by NUS Hackers. You can join our{' '}
            <a href="https://discord.gg/Ub4W6bNRch" target="_blank">Discord</a> to learn more about 
            Advent of Code, talk about the problems, and share your solutions with 
            other members!
          </p>
          <p>
          ...
          {showBadges && (
            <p>
              ...
              <ul>
                <li>
                  A <span className="star-count">ticket</span> 🎫 to enter the NUS Hackers Lucky Draw - which you
                  can obtain by getting <span className="star-count">20 stars</span>! We will be giving away prizes
                  to 15 lucky winners!
                </li>
                <li>
